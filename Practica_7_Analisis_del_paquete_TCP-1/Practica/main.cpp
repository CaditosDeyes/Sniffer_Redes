...
//Archivos usados "ethernet_ipv4_tcp_irc.bin" "ethernet_ipv4_udp_dns.bin"
...
int main(){
    ...
    int i=0, aux=0, band=0, tamanio=0, version=0, prioridad=0, sumaLTI=0, prot=0, frag=0, dec16=0, sum1=0, sum2=0, auxsum=0, bit4dec=0, bit3dec=0;
    long long int dec32=0;

    if ((archivo = fopen("ethernet_ipv4_tcp_irc.bin", "rb+")) == NULL){
